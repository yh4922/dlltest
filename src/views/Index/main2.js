...
let veLib = new ffi.Library(dllFile, {
  ...
  getCameraFrameRGB: [
    ...
    [
      ...
      charArray, // 暂时为零 后续保留参数 'unsigned char *pdata'
...
// 获取视频帧
function getImages() {
  let imgBuf = new Buffer(1000*562*3) // 图片数据指针
  imgBuf.type = charArray
...
// 这中方式在运行到第三步的时候就报错
// Failed to resolve async component default: Error: error setting argument 2 - not sure how to set into Array: 
// error setting argument 2 - not sure how to set into Array: 